...
if __name__ == "__main__":
    ...
    parser.add_argument('--structure-shape', '--structure_shape', dest='structure_shape', nargs=2, type=int, default=(5,5), metavar=('HEIGHT', 'WIDTH'), help='Shape of the structure as HEIGHT WIDTH (default: 5 5)')
