...
class StationaryJump_10x10(BenchmarkBase):
    ...
    def __init__(
        ...
        # make world
        self.world = EvoWorld.from_json(os.path.join(self.DATA_PATH, 'Jumper-v0-10x10.json'))
        self.world.add_from_array('robot', body, 64, 1, connections=connections)
