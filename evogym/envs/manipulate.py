...
class CarrySmallRect_10x10(PackageBase):
    ...
    def __init__(
        ...
        # make world
        self.world = EvoWorld.from_json(os.path.join(self.DATA_PATH, 'Carrier-v0-10x10.json'))
        self.world.add_from_array('robot', body, 1, 1, connections=connections)
...
class PushSmallRect_10x10(PackageBase):
    ...
    def __init__(
        ...
        # make world
        self.world = EvoWorld.from_json(os.path.join(self.DATA_PATH, 'Pusher-v0-10x10.json'))
        self.world.add_from_array('robot', body, 1, 1, connections=connections)
