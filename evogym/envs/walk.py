...
class WalkingFlat_10x10(BenchmarkBase):
    ...
    def __init__(
        ...
        # make world
        self.world = EvoWorld.from_json(os.path.join(self.DATA_PATH, 'Walker-v0-10x10.json'))
        self.world.add_from_array('robot', body, 1, 1, connections=connections)
    ...
    def step(self, action):
        ...
        # check goal met
        if com_2[0] > 198*self.VOXEL_SIZE:
            done = True
            reward += 1.0
...
class SoftBridge_10x10(BenchmarkBase):
    ...
    def __init__(
        ...
        # make world
        self.world = EvoWorld.from_json(os.path.join(self.DATA_PATH, 'BridgeWalker-v0-10x10.json'))
        self.world.add_from_array('robot', body, 2, 9, connections=connections)
    ...
    def step(self, action):
        ...
        # check goal met
        if com_2[0] > (112)*self.VOXEL_SIZE:
            done = True
            reward += 1.0
