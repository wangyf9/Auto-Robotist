...
class Climb0_10x10(ClimbBase):
    """Climber-v0 widened for 10x10 robot bodies."""
    ...
    def __init__(
        ...
        # make world
        self.world = EvoWorld.from_json(os.path.join(self.DATA_PATH, 'Climber-v0-10x10.json'))
        self.world.add_from_array('robot', body, 1, 1, connections=connections)
    ...
    def step(self, action):
        ...
        # check termination condition
        if com_2[1] > (172)*self.VOXEL_SIZE:
            done = True
            reward += 1.0
