...
register(
    id = 'Walker-v0-10x10',
    entry_point = 'evogym.envs.walk:WalkingFlat_10x10',
    max_episode_steps=500
)
...
register(
    id = 'BridgeWalker-v0-10x10',
    entry_point = 'evogym.envs.walk:SoftBridge_10x10',
    max_episode_steps=500
)
...
register(
    id = 'Jumper-v0-10x10',
    entry_point = 'evogym.envs.jump:StationaryJump_10x10',
    max_episode_steps=500
)
...
register(
    id = 'Balancer-v0-10x10',
    entry_point = 'evogym.envs.balance:Balance_10x10',
    max_episode_steps=600
)
...
register(
    id = 'UpStepper-v0-10x10',
    entry_point = 'evogym.envs.traverse:StepsUp_10x10',
    max_episode_steps=600
)
...
register(
    id = 'Carrier-v0-10x10',
    entry_point = 'evogym.envs.manipulate:CarrySmallRect_10x10',
    max_episode_steps=500
)
...
register(
    id = 'Pusher-v0-10x10',
    entry_point = 'evogym.envs.manipulate:PushSmallRect_10x10',
    max_episode_steps=500
)
...
register(
    id = 'Climber-v0-10x10',
    entry_point = 'evogym.envs.climb:Climb0_10x10',
    max_episode_steps=400
)
