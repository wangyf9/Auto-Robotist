...
class Balance_10x10(BenchmarkBase):
    ...
    def __init__(
        ...
        # make world
        self.world = EvoWorld.from_json(os.path.join(self.DATA_PATH, 'Balancer-v0-10x10.json'))
        self.world.add_from_array('robot', body, 30, 5, connections=connections)
    ...
    def get_obs(self, pos_final):
        ...
        return np.array([
            34.5*self.VOXEL_SIZE - com_final[0],
            11*self.VOXEL_SIZE - com_final[1],
        ])
    ...
    def get_reward(self, pos_init, pos_final):
        ...
        reward = abs(34.5*self.VOXEL_SIZE - com_init[0]) - abs(34.5*self.VOXEL_SIZE - com_final[0])
        reward += (abs(10.0*self.VOXEL_SIZE - com_init[1]) - abs(10.0*self.VOXEL_SIZE - com_final[1]))
        return reward
